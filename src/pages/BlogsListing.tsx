    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-b from-[#1a1a1a] to-[#0d0d0d] text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          ...
          >
            <span className="text-[11px] uppercase tracking-[0.32em] text-[#c8a96b]">
              Travel Journal
            </span>
            ...
            <p className="text-white/70 mt-5 max-w-xl mx-auto leading-relaxed">
              Curated guides, cultural stories and luxury travel
              inspiration from across the heart of incredible India.
            </p>
          </motion.div>
        </div>
      </section>
