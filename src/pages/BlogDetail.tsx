    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <div className="max-w-4xl mx-auto px-4 pt-8">
        <nav className="flex items-center gap-2 text-[12px] uppercase tracking-[0.2em] text-[#888]">
          ...
          <span className="text-[#111] truncate max-w-[180px]">
            {blog.shortTitle}
          </span>
        </nav>
      </div>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        {blog.content.map((block, i) => {
          ...
          if (block.type === "paragraph") {
            return (
              <p
                key={i}
                className="text-[16px] leading-[1.85] text-[#444] mb-5"
              >
                {block.text}
              </p>
            );
          ...
          return (
            <ul key={i} className="space-y-2 mb-6 ml-2">
              {block.items.map((item, j) => (
                <li
                  key={j}
                  className="flex items-start gap-3 text-[16px] text-[#444]"
                >
        ...
        <Link
          to="/blogs"
          className="inline-flex items-center gap-2 mt-10 text-[12px] uppercase tracking-[0.25em] text-[#b8955d] hover:text-black transition-colors"
        >
          <ArrowLeft size={14} />
        ...
        <section className="bg-white border-t border-black/5 py-16">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <p className="text-[#666] text-[14px] mb-10">
              More stories from the heart of Madhya Pradesh.
            </p>
              ...
              {related.map((r) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="font-display text-[18px] font-bold text-[#111] mt-3 line-clamp-2 group-hover:text-[#b8955d] transition-colors">
                      {r.title}
                    </h3>
                  </div>
                </Link>
