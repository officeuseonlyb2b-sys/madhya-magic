...
const PrivacyPolicy = () => {
    return (
        ...
        /> */}
                ...
                {/* Content */}
                <section className="max-w-4xl mx-auto px-6 md:px-10 py-16 lg:py-20">
                    <p className="text-sm text-gray-500 mb-8">
                        <strong>Last updated:</strong> June 08, 2024
                    </p>
                    ...
                    <div className="space-y-10 text-[17px] leading-8 text-gray-700">
                        ...
                        <div>
                            ...
                            <ul className="list-disc pl-8 mt-4 space-y-3">
                                ...
                                <li>
                                    ...
                                    "We", "Us" or "Our" in this Agreement) refers to Enchanting MP,
                                    Madhya Pradesh.
                                </li>
                                <li>
                                ...
                                <li>
                                    <strong>Website</strong> refers to Enchanting MP, accessible from{" "}
                                    <a
                                        href="https://www.enchantingmp.com"
                                        className="text-blue-600 underline"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        https://www.enchantingmp.com/
                                    </a>
                                </li>
                                <li>
                        ...
                        {/* Retention, Transfer, Delete, Disclosure... */}
                        <div>
                            <h2 className="text-3xl font-bold mb-6 text-gray-900">
                        ...
                        <div>
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 mt-4 shadow-sm border border-blue-200">
                                <p className="text-lg">
                                    <strong>Email:</strong>{" "}
                                    <a
